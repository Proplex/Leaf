...
public class BoardCategoryIndexer implements SectionIndexer {
   ...
   // protected CharSequence mAlphabet;
    ...
    public BoardCategoryIndexer(BoardDataSource<Board> data) {
        mArray = data;
        mAlphabetLength = co.wakarimasen.ceredux.imageboard.Board.categories.size();
        mAlphabetArray = new String[mAlphabetLength];
        for (int i = 0; i < mAlphabetLength; i++) {
            mAlphabetArray[i] = co.wakarimasen.ceredux.imageboard.Board.categories.get(i).getName();
        }
